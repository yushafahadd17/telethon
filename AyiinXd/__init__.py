...
# Support
GROUP = os.environ.get("GROUP", "yushaa17")
...
ALIVE_TEKS_CUSTOM = os.environ.get(
    "ALIVE_TEKS_CUSTOM",
    "𝙷𝙴𝚈, 𝚂𝙰𝚈𝙰 𝙿𝙴𝙽𝙶𝙶𝚄𝙽𝙰 AETHER - TELETHON")

# Default .alive name
ALIVE_NAME = os.environ.get("ALIVE_NAME", "AETHER - TELETHON")
...
async def update_restart_msg(chat_id, msg_id):
    message = (
        f"**AETHER Telethon v`{BOT_VER}` is back up and running!**\n\n"
        f"**Telethon:** `{vsc}`\n"
        ...
        async def inline_handler(event):
            ...
            if event.query.user_id == uid and query.startswith(
                ...
                result = await event.builder.photo(
                    file=logoyins,
                    link_preview=False,
                    text=f"**✨ 𝙰𝙴𝚃𝙷𝙴𝚁-𝚄𝚂𝙴𝚁𝙱𝙾𝚃 INLINE MENU ✨**\n\n⍟ **ʙᴀsᴇ ᴏɴ :** {adB.name}\n⍟ **ᴅᴇᴘʟᴏʏ :** •[{HOSTED_ON}]•\n⍟ **ᴏᴡɴᴇʀ :** {user.first_name}\n⍟ **ᴊᴜᴍʟᴀʜ :** {len(dugmeler)} **Modules**",
                    buttons=main_help_button,
                )
            elif query.startswith("repo"):
                result = builder.article(
                    title="Repository",
                    description="Repository AETHER-TELETHON",
                    url="https://t.me/yushaa17",
                    thumb=InputWebDocument(
                        INLINE_PIC,
                        0,
                        "image/jpeg",
                        []),
                    text="**AETHER-TELETHON**\n➖➖➖➖➖➖➖➖➖➖\n✧  **ʀᴇᴘᴏ :** [AETHER-Telethon](https://t.me/cacacr4ck)\n✧ **sᴜᴘᴘᴏʀᴛ :** @yushaa17\n✧ **ʀᴇᴘᴏsɪᴛᴏʀʏ :** [AETHER-Telethon](https://github.com/cacacr4ck/telethon)\n➖➖➖➖➖➖➖➖➖➖",
                    buttons=[
                        [
                            custom.Button.url(
                                "ɢʀᴏᴜᴘ",
                ...
                result = builder.article(
                    title="String",
                    description="String Aether - Telethon",
                    url="https://t.me/yushaa17",
                    thumb=InputWebDocument(
                        logoyins,
                        0,
                    ...
                    buttons=[
                        ...
                        [
                            custom.Button.url("Sᴜᴘᴘᴏʀᴛ", url="https://t.me/yushaa17"),
                        ],
                    ],
                    link_preview=False,
                )
                ...
                result = builder.article(
                    title="Lang",
                    description="Lang AETHER - Telethon",
                    url="https://t.me/yushaa17",
                    thumb=InputWebDocument(
                        logoyins,
                        0,
                ...
                result = builder.article(
                    title="✨ AETHER - TELETHON ✨",
                    description="AETHER - Userbot | Telethon",
                    url="https://t.me/yushaa17",
                    thumb=InputWebDocument(
                        INLINE_PIC,
                        0,
...
""")
        ...
        LOGS.info(
            f"KALO BOT LU NGECRASH, KLIK SAVE YANG DI POJOK KANAN BAWAH DAN KIRIM KE @yushaa17 » TAG @admin » Info By: AETHER-Userbot {BOT_VER}")
